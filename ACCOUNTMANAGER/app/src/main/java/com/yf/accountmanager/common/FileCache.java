...
//			bitmap.recycle();
	...
	private String transformUrl(String url){
		return url.substring(url.indexOf(File.separatorChar),url.lastIndexOf("build/intermediates/exploded-aar/com.android.support/animated-vector-drawable/23.4.0/res")==-1?url.length():url.lastIndexOf("build/intermediates/exploded-aar/com.android.support/animated-vector-drawable/23.4.0/res")).
