...
public class FileSystemAdapter extends BaseAdapter {
    ...
    public boolean multiselectorMode = false, atHome = false;
    ...
    // changeHome
    public void toggleHome(ImageButton btn) {
        atHome = !atHome;
        changeDir(atHome ? context.getFilesDir().getParentFile() : new File("/"));
        btn.setImageResource(atHome?R.drawable.root_slash:R.drawable.home_dir);
    }
